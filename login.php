...
<head>
    ...
    <style>
        ...
        .login-card { background: white; padding: 50px; border-radius: 24px; box-shadow: 0 20px 50px rgba(0,0,0,0.05); width: 400px; text-align: center; border: 1px solid #f1f5f9; }
        h2 { color: #0f172a; margin-bottom: 10px; font-weight: 800; }
